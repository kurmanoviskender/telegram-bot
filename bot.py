...
bot = telebot.TeleBot('678402419:AAHnjAuZUrMwtFMXfMtkALWSZalX5HsH7Ow')
    ...
    try:
        if tries > 0:
            ...
            if int(answer) == number:
                bot.send_message(message.chat.id, 'Поздравляю! Ты угадал! Держи стикер! ')
                tries = 6
